...
def ClassificationRemain(imgb0, imgb1, imgb2, imgb3, changemask, outname, train, test):
    ...
    for data in train_data:
        ...
        #B1, B2, Class = float(data[0]), float(data[1]), float(data[2])
    ...
    DelTif(change_data, change_band, change_set)
